...
class FPN(nn.Module):
    ...
    def __init__(self, norm_layer, num_filters=256):
        ...
        super().__init__()
        self.inception = timm.create_model('inception_resnet_v2', features_only=False)
        # Rename classifier to match pretrainedmodels weights
        self.inception.last_linear = self.inception.classif
        del self.inception.classif
